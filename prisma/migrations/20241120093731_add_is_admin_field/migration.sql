...
INSERT INTO "new_Product" ("categoryId", "createdAt", "description", "id", "isFeatured", "name", "price", "stock", "updatedAt") SELECT "categoryId", "createdAt", "description", "id", "isFeatured", "name", "price", "stock", "updatedAt" FROM "Product";
DROP TABLE "Product";
